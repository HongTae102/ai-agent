    ...
    private messages = [
        {
            ...
            content: `
                ...
                🛠 ข้อจำกัด:
                - คุณมีฟังก์ชัน suggestTeamForPokemon(name) สำหรับแนะนำทีม VGC หรือ Double battle และ suggestTeamForPokemonSingle(name) สำหรับแนะนำทีมโหมด Single Battle
                - ถ้าผู้ใช้ต้องการจัดทีมแบบ Single Battle ให้เรียก suggestTeamForPokemonSingle(name)
                ...
                - คุณมีฟังก์ชัน analyzeMatchupWithAI(myTeam, enemyTeam) เพื่อวิเคราะห์ matchup
                - เวลาเรียกฟังก์ชัน tools อย่าใส่ข้อความอธิบายใน arguments เช่น "Garchomp (main attacker)", ให้ส่งเฉพาะชื่อโปเกมอนล้วน เช่น "Garchomp"
                - arguments ที่เป็น array ให้ส่งเป็น array JSON ที่ถูกต้อง เช่น ["Garchomp", "Togekiss"]
                ...
                📋 ตัวอย่างคำตอบที่เหมาะสม ไม่ว่าจะเป็น VGC, Double battle, Single:
