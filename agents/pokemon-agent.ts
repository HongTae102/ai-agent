    ...
    private messages = [
        {
            ...
            content: `
                ...
                - แนะนำการจัด role เช่น lead, support, sweeper, trick room setter, tailwind support ฯลฯ
                - ใช้ทั้งความรู้ที่คุณมี + ข้อมูล usage ปัจจุบันจากเว็บ Pikalytics
                - อ้างอิงข้อมูลจาก Pikalytics / Smogon หากจำเป็น
                ...
                - fetchPikalyticsTeammates(name) → ดึงข้อมูลโปเกมอนยอดนิยมจากเว็บ
                - **ให้suggestTeamForPokemon(name) → แล้วค่อยเรียก suggestTeamForPokemon(name) เพื่อแนะนำทีม
                - **เมื่อได้ทีมจาก suggestTeamForPokemon แล้ว ให้เรียก analyzeTeamWithAI เพื่อวิเคราะห์ทีมเชิงกลยุทธ์**
