    ...
    private messages = [
        {
            ...
            content: `
                ...
                🛠 ข้อจำกัด:
                - ใช้ suggestTeamForPokemon(name) เพื่อแนะนำทีมทั้งหมด
                - คุณมีฟังก์ชัน suggestTeamForPokemon(name) สำหรับ VGC หรือ Double battle และ suggestTeamForPokemonSingle(name) สำหรับโหมด Single Battle
